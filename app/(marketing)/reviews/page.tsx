...
const reviews = [
    {
        ...
        review: 'I\'ve tried at least 5 different providers over the past 2 years. Stream4U is by far the most reliable. Zero buffering, amazing channel selection, and the custom app is better than most paid streaming services. The 4K quality on my LG OLED is stunning.',
        plan: '12 Months',
        date: 'February 2026',
    },
    {
    ...
    },
    {
        ...
        review: 'Cancelled my cable subscription ($180/month) and switched to Stream4U. I now pay a fraction of the price and get 10x the content. The Arabic and French channels are excellent, and the VOD library is always being updated with new releases.',
        plan: '12 Months',
        date: 'January 2026',
    },
    {
    ...
    },
    {
        ...
        rating: 5,
        title: 'Goodbye Netflix, hello Stream4U',
        review: 'The VOD library alone makes this worth it. I cancelled Netflix, Disney+, and HBO Max. Stream4U has everything in one place and the two-connection plan means my kids can watch their shows while I watch mine.',
        plan: '6 Months',
        date: 'January 2026',
    },
]
